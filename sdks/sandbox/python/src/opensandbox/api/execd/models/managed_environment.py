...
T = TypeVar("T", bound="ManagedEnvironment")


@_attrs_define
class ManagedEnvironment:
    """Environment patch applied over execd's scrubbed base; null removes a name."""
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        managed_environment.additional_properties = additional_properties
