...
from ...models.create_managed_process_request import CreateManagedProcessRequest
...
def _get_kwargs(
    *,
    body: CreateManagedProcessRequest,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ManagedProcessStatus.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create a managed process
     ...
     Starts an exact-argv process. Repeating an operation ID with the identical request returns the
    original process.
